import { iconStrokedPaw } from "../../helper";

export default function PetCard() {
  return (
    <>
      <div className="w-[231.20px] h-[301.20px] mb-[108px] mx-2 mt-6 bg-violet-800 rounded-[10px] shadow flex-col justify-center items-start inline-flex">
        ...
        <button className="self-stretch h-16 pt-px border-t border-purple-950 justify-center items-center inline-flex">
